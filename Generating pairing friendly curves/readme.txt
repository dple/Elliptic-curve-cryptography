...
The program implement three methods to generate a pairing-friendly ellitptic curve: the MNT method, the Cocks-Pinch method, and the Brezing-Wang method. Essentially, these methods perform the two following steps:
